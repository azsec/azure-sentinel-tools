...
| [Delete-AzSentinelIncidentList.ps1](https://github.com/azsec/azure-sentinel-tools/blob/master/scripts/Delete-AzureSentinelIncident.ps1 | This script allows you to delete an Azure Sentinel incident | 
