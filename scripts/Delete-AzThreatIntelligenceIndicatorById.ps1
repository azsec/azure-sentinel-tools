<#
    .SYNOPSIS
        This script is used to delete a custom Threat Intelligence (TI) Indicators by Name in your Azure Sentinel.
    .DESCRIPTION
        This script is used to delete a custom Threat Intelligence (TI) Indicators by Name in your Azure Sentinel.
    .NOTES
        ...
        Prerequisite  : Az
    .EXAMPLE
        .\Delete-AzThreatIntelligenceIndicatorById.ps1 -WorkspaceRg "azsec-corporate-rg" `
